...
<Playground url="https://search-playground.mongodb.com/tools/code-sandbox/snapshots/6984fef8968279618745dce3">🔗 Playground link: score not projected</Playground>

Fix this Playground so that the `score` being projected is the relevancy score MongoDB Search uses for default sorting.
