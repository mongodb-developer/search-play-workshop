...
5. **Data modeling and schema design for MongoDB Search**
    - Best practices

## What you'll need

This workshop uses the MongoDB Search Playground for the exercises.
