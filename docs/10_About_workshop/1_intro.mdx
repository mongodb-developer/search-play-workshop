...
The MongoDB Search Playground (or just Playground) is used for the exercises in this workshop.
The Playground is a self-contained lightweight, yet feature-rich MongoDB Search environment
...
To begin, navigate to the [MongoDB Search Playground](https://search-playground.mongodb.com/).
...
## Resources
  * <Link to="https://www.mongodb.com/developer/products/atlas/search-playground-intro/">MongoDB Search Playground: Easy Experimentation</Link> (article)

------

Let's dive into the world of MongoDB Search using this convenient and powerful playground environment!
